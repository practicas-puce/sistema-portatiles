...
CREATE TABLE prestamos (
    ...
    administrador_id INT NOT NULL,         -- El admin que entrega el préstamo
    responsable_devolucion_id INT,          -- El admin que recibe y certifica la devolución
    ...
    CONSTRAINT fk_responsable_devolucion FOREIGN KEY (responsable_devolucion_id) REFERENCES usuarios(id) ON DELETE RESTRICT,
...
CREATE INDEX idx_prestamos_responsable_devolucion ON prestamos(responsable_devolucion_id);
